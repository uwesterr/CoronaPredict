...
calcRestanteilStartwert <- function(calcDf, n0_erfasst, ta, startDate) {
  calcDf <- calcDf %>% tail(1)
  max(0,n0_erfasst*(ta - as.numeric(calcDf$Tag - startDate) )/ta)
}

calcDf$RestanteilStartwert<- calcRestanteilStartwert(calcDf, n0_erfasst, ta, startDate)
